 ...
 * Article
 *
 * @ORM\Table(name="article", indexes={@ORM\Index(name="category", columns={"category"}), @ORM\Index(name="category_2", columns={"category"})})
 * @ORM\Entity
 */
class Article
{
     ...
     * @var string
     *
     * @ORM\Column(name="short_article", type="string", length=300, nullable=true)
     */
